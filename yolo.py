...
#
# This is modifed from YOLO object detection with OpenCV [https://www.pyimagesearch.com/2018/11/12/yolo-object-detection-with-opencv/]
#
...
print("[INFO] {}: YOLO took {:.6f} seconds".format(args['image'], end - start))
